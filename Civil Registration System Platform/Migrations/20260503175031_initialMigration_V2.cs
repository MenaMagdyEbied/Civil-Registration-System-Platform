...
namespace Civil_Registration_System_Platform.Migrations
{
    ...
    public partial class initialMigration_V2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ServicesTypeHelpers",
                columns: table => new
                {
                    ServicesTypeEnum = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Price = table.Column<int>(type: "int", nullable: false),
                    DurationInDays = table.Column<int>(type: "int", nullable: false),
                    Details = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicesTypeHelpers", x => x.ServicesTypeEnum);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EGPhoneNumber = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Offices_ManageOfficeId",
                        column: x => x.ManageOfficeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Applications_Offices_OfficeId",
                        column: x => x.OfficeId,
                        principalTable: "Offices",
                        principalColumn: "OfficeId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApplicationDocumentsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationDocuments", x => x.ApplicationDocumentsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_ScheduledById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TimelineEntryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimelineEntries", x => x.TimelineEntryId);
                    table.ForeignKey(
                        name: "FK_TimelineEntries_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "ApplicationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimelineEntries_AspNetUsers_PerformedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ManageOfficeId",
                table: "AspNetUsers",
                column: "ManageOfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimelineEntries_ApplicationId",
                table: "TimelineEntries",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_TimelineEntries_PerformedById",
                table: "TimelineEntries",
